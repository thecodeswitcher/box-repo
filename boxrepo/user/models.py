...
class Account(models.Model):
    ...
    account_type = models.CharField(
        max_length=255, default=ACCOUNT_TYPE_FREE, choices=ACCOUNT_TYPE_CHOICES
    )
    account_paid_months = models.IntegerField(
        null=True, choices=ACCOUNT_PAID_MONTHS_CHOICES
    )
